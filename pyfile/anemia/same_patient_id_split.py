...
data=pd.read_csv('/home/minkyoon/crom/pyfile/anemia/anemia.csv')
...
train_acc_nums, rest_acc_nums = train_test_split(unique_accession_numbers, test_size=0.7, random_state=42)
valid_acc_nums, test_acc_nums = train_test_split(rest_acc_nums, test_size=0.857, random_state=42)
...
import pandas as pd
df=pd.read_csv('/home/minkyoon/crom/pyfile/anemia/test.csv')