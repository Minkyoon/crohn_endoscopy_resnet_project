...
model = CLAM_SB()
state_dict = torch.load('/home/minkyoon/first/CLAM/results/task_1_tumor_vs_normal_CLAM_50_s1/s_0_checkpoint.pt')
model.load_state_dict(state_dict)    
    
# 데이터 로드
data=torch.load('/home/minkyoon/crom/pyfile/relapse/mlp/mlpcsvpt/1605057954.pt')
...
# CSV 파일에서 데이터 로드
data = pd.read_csv('/home/minkyoon/crom/pyfile/relapse/mlp/mlpcsvpt/1605057954.csv')
